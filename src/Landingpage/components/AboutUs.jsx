...
const AboutUs = () => {
  ...
  return (
    <figure className="flex flex-col py-12 px-6 sm:px-12 lg:px-20 gap-5">
      ...
      <div className="flex flex-row gap-5 max-w-">
        {/* Animated Paragraph */}
        <motion.p
          className="text-base sm:text-lg lg:text-xl max-w-[400px] md:max-w-md lg:max-w-4xl"
          initial={{ opacity: 0 }}
        ...
        <div className="relative w-1/2 rounded-md overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300">
            <p className="text-white text-lg md:text-sm lg:text-2xl font-semibold">
